...
const config = {
    ...
    scene: [Iniciarsesion, MenuPrincipal, Chat, TutorialScene1, TutorialScene2, TutorialScene3, Creditos, GameOnline1,Mapa, MapaOnline, GameLocal1, GameLocal2, PauseMenu, ResultScreen], // Scene que contiene la lógica del juego
...
let gatoA, gatoB, cursor,keys,izqA,izqB,arribaA,arribaB,peces,gatoAwait,gatoBwait, puntosA=0, puntosB=0, textoA, textoB, arbusto,pez,zonasProhibidas,tierra,pesca,mapa, abiertoA, abiertoB, pezGloboA, pezGloboB,agua,mapaElegido, gameID, nombreA, nombreB,botonServer, DescampadoButton,JuegoMButton,nextButton;
